let Extend = require('material-ui/lib/utils/extend');


const Types = {
  LIGHT: require('material-ui/lib/styles/themes/light-theme'),
  DARK: require('material-ui/lib/styles/themes/dark-theme'),
};
